...
export default function NotFound() {
  ...
  return (
    <section className="section min-h-screen flex items-center justify-center bg-[var(--body-color)]">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--title-color)] mb-4">
              Oops! Page Not Found
            </h2>
            <p className="text-lg text-[var(--text-color)] mb-8 leading-relaxed max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link href="/" className="btn-grad">
                <i className="uil uil-estate mr-2"></i>
                Back to Home
              </Link>
              <Link href="/projects" className="btn-grad">
                <i className="uil uil-scenery mr-2"></i>
                View Projects
              </Link>
            </div>

            {/* Helpful Links */}
            <div className="mt-12 pt-8 border-t border-[var(--first-color-lighter)]">
              <p className="text-sm text-[var(--text-color-light)] mb-4">
                Here are some helpful links instead:
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Link 
                  href="/about" 
                  className="text-[var(--first-color)] hover:text-[var(--first-color-alt)] transition-colors"
                >
                  About
                </Link>
      ...
      <style jsx>{`
        /* Design Inspired by Stefan Devai's Design on Dribble */
